...
import { handler } from '../handlers/blockAccount.js';
...
describe('handler function', () => {
  ...
  it('should block an account when it exists', async () => {
    const event = {
    ...
    prisma.account = {
      findFirst: jest.fn().mockResolvedValue({ id: 1, number: '123456', isBlocked: false }),
